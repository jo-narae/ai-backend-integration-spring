package com.frentis.aibackend.security;
 ...
 *
 * 주의사항:
 * - WebSecurityConfigurerAdapter는 6에서 제거됨 → SecurityFilterChain Bean 방식만 사용
 * - 람다 DSL 강제 사용
 * - authorizeRequests 에서 authorizeHttpRequests 로 변경
 * - antMatchers 에서 requestMatchers 로 변경
 * - AuthenticationManager는 더 이상 자동 노출되지 않음 → Bean으로 명시 구성
 */
@Configuration
@EnableWebSecurity
